namespace EPR.Payment.Service.Common.Constants.RegistrationFees.Exceptions
{
    public static class ProducerFeesRepositoryConstants
    {
        ...
        public const string InvalidOnlineMarketRegulatorError = "Producer Online Market Fee record not found for regulator";
        public const string InvalidLateFeeError = "Producer Late Fee record not found for regulator";
    }
}
