...
INSERT INTO [Lookup].[AdditionalRegistrationFees] ([Id], [Amount], [Description], [EffectiveFrom], [EffectiveTo], [FeesSubType], [Regulator])
...
INSERT INTO [Lookup].[ComplianceSchemeRegistrationFees] ([Id], [Amount], [Description], [EffectiveFrom], [EffectiveTo], [FeesType], [Regulator])
...
INSERT INTO [Lookup].[PaymentStatus] ([Id], [Status])
...
INSERT INTO [Lookup].[ProducerRegistrationFees] ([Id], [Amount], [Description], [EffectiveFrom], [EffectiveTo], [ProducerType], [Regulator])
...
INSERT INTO [Lookup].[SubsidiariesRegistrationFees] ([Id], [Amount], [Description], [EffectiveFrom], [EffectiveTo], [MaxNumberOfSubsidiaries], [MinNumberOfSubsidiaries], [Regulator])
...
CREATE UNIQUE INDEX [IX_Payment_GovpayPaymentId] ON [Payment] ([GovpayPaymentId]) WHERE [GovpayPaymentId] IS NOT NULL;
GO
...
INSERT INTO [Lookup].[Regulator] ([Id], [Description], [Type])
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 262000.0
WHERE [Id] = 1;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 121600.0
WHERE [Id] = 5;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 165800.0
WHERE [Id] = 9;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 63100.0
WHERE [Id] = 13;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 1380400.0
WHERE [Id] = 17;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 257900.0
WHERE [Id] = 21;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 55800.0
WHERE [Id] = 25;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 14000.0
WHERE [Id] = 29;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [EffectiveFrom] = '2024-01-01T00:00:00.0000000Z', [EffectiveTo] = '2025-12-31T23:59:59.0000000Z'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 257900.0, [GroupId] = 1, [SubGroupId] = 4
WHERE [Id] = 9;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 165800.0, [SubGroupId] = 1
WHERE [Id] = 13;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 63100.0, [SubGroupId] = 2
WHERE [Id] = 17;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 1380400.0, [SubGroupId] = 3
WHERE [Id] = 21;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 257900.0, [GroupId] = 2, [SubGroupId] = 4
WHERE [Id] = 25;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 55800.0, [SubGroupId] = 5
WHERE [Id] = 29;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 14000.0, [GroupId] = 3, [SubGroupId] = 6
WHERE [Id] = 33;
SELECT @@ROWCOUNT;
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 14000.0, [GroupId] = 4, [SubGroupId] = 6
WHERE [Id] = 41;
SELECT @@ROWCOUNT;
...
CREATE UNIQUE INDEX [IX_OnlinePayment_GovPayPaymentId] ON [OnlinePayment] ([GovPayPaymentId]) WHERE [GovPayPaymentId] IS NOT NULL;
GO
...
UPDATE [Lookup].[RegistrationFees] SET [Amount] = 168500.0
WHERE [Id] = 13;
SELECT @@ROWCOUNT;
