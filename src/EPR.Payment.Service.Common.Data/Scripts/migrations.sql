...
BEGIN
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Amount', N'EffectiveFrom', N'EffectiveTo', N'GroupId', N'RegulatorId', N'SubGroupId') AND [object_id] = OBJECT_ID(N'[Lookup].[RegistrationFees]'))
        SET IDENTITY_INSERT [Lookup].[RegistrationFees] ON;
    EXEC(N'INSERT INTO [Lookup].[RegistrationFees] ([Id], [Amount], [EffectiveFrom], [EffectiveTo], [GroupId], [RegulatorId], [SubGroupId])
    VALUES (26000068, 38600.0, ''2026-10-01T00:00:00.0000000Z'', ''2050-12-31T23:59:59.0000000Z'', 3, 1, 8),
    (26000069, 38600.0, ''2026-10-01T00:00:00.0000000Z'', ''2050-12-31T23:59:59.0000000Z'', 3, 2, 8),
    (26000070, 38600.0, ''2026-10-01T00:00:00.0000000Z'', ''2050-12-31T23:59:59.0000000Z'', 3, 3, 8),
    (26000071, 38600.0, ''2026-10-01T00:00:00.0000000Z'', ''2050-12-31T23:59:59.0000000Z'', 3, 4, 8),
    (26000072, 38600.0, ''2026-10-01T00:00:00.0000000Z'', ''2050-12-31T23:59:59.0000000Z'', 4, 1, 8),
    (26000073, 38600.0, ''2026-10-01T00:00:00.0000000Z'', ''2050-12-31T23:59:59.0000000Z'', 4, 2, 8),
    (26000074, 38600.0, ''2026-10-01T00:00:00.0000000Z'', ''2050-12-31T23:59:59.0000000Z'', 4, 3, 8),
    (26000075, 38600.0, ''2026-10-01T00:00:00.0000000Z'', ''2050-12-31T23:59:59.0000000Z'', 4, 4, 8)');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Amount', N'EffectiveFrom', N'EffectiveTo', N'GroupId', N'RegulatorId', N'SubGroupId') AND [object_id] = OBJECT_ID(N'[Lookup].[RegistrationFees]'))
        SET IDENTITY_INSERT [Lookup].[RegistrationFees] OFF;
END;
