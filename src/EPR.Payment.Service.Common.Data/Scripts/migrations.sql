...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260528131356_AddRegistrationSubmissionData', N'8.0.28');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260529091235_AddRegistrationSubmissionProducerAndSubsidiary', N'8.0.28');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260601091016_AddRegistrationBlobNameToRegistrationSubmissionData'
)
BEGIN
    ALTER TABLE [RegistrationSubmissionData] ADD [RegistrationBlobName] nvarchar(100) NOT NULL DEFAULT N'';
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260601091016_AddRegistrationBlobNameToRegistrationSubmissionData', N'8.0.28');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260603133301_AddRegistrationSubmissionDataUniqueIndex'
)
BEGIN
...
BEGIN
    CREATE UNIQUE INDEX [IX_RegistrationSubmissionData_SubmissionId_FileId] ON [RegistrationSubmissionData] ([SubmissionId], [FileId]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260603133301_AddRegistrationSubmissionDataUniqueIndex', N'8.0.28');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260604100043_MoveRegistrationSubmissionTablesToRegistrationSchema'
)
BEGIN
...
BEGIN
    ALTER SCHEMA [registration] TRANSFER [RegistrationSubmissionSubsidiary];
END;
GO
...
BEGIN
    ALTER SCHEMA [registration] TRANSFER [RegistrationSubmissionProducer];
END;
GO
...
BEGIN
    ALTER SCHEMA [registration] TRANSFER [RegistrationSubmissionData];
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260604100043_MoveRegistrationSubmissionTablesToRegistrationSchema', N'8.0.28');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260610155517_RemoveFileIdFromRegistrationSubmissionData', N'8.0.28');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260615144607_RemoveUpdatedDateFromRegistrationSubmissionData', N'8.0.28');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260623101617_AlterSubmissionPeriodMaxLength'
)
BEGIN
    ...
    IF @var31 IS NOT NULL EXEC(N'ALTER TABLE [registration].[RegistrationSubmissionData] DROP CONSTRAINT [' + @var31 + '];');
    ALTER TABLE [registration].[RegistrationSubmissionData] ALTER COLUMN [SubmissionPeriod] nvarchar(50) NOT NULL;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260623101617_AlterSubmissionPeriodMaxLength', N'8.0.28');
END;
GO
