...
namespace EPR.Payment.Service.Common.Data.Migrations
{
    ...
    [Migration("20260903143105_SUB-225-add-subsidiary-late-fee")]
    partial class SUB225addsubsidiarylatefee
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EPR.Payment.Service.Common.Data.DataModels.Lookups.RegistrationFees", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            EffectiveTo = new DateTime(2050, 12, 31, 23, 59, 59, 0, DateTimeKind.Utc),
                            GroupId = 2,
                            RegulatorId = 1,
                            SubGroupId = 1
                        },
                        ...
                        new
                        {
                            Id = 26000068,
                            Amount = 38600m,
                            EffectiveFrom = new DateTime(2026, 10, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            EffectiveTo = new DateTime(2050, 12, 31, 23, 59, 59, 0, DateTimeKind.Utc),
                            GroupId = 3,
                            RegulatorId = 1,
                            SubGroupId = 8
            ...
            modelBuilder.Entity("EPR.Payment.Service.Common.Data.DataModels.RegistrationFeeLineItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid>("RegistrationFeeSnapshotId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RegistrationFeeSnapshotId", "FeeTypeId");

                    b.ToTable("RegistrationFeeLineItem", "registration");
                });

            modelBuilder.Entity("EPR.Payment.Service.Common.Data.DataModels.RegistrationFeeSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("RegistrationFeeSnapshot", "registration");
                });
            ...
            modelBuilder.Entity("EPR.Payment.Service.Common.Data.DataModels.RegistrationFeeLineItem", b =>
                {
                    b.HasOne("EPR.Payment.Service.Common.Data.DataModels.RegistrationFeeSnapshot", "RegistrationFeeSnapshot")
                        .WithMany("LineItems")
                        .HasForeignKey("RegistrationFeeSnapshotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RegistrationFeeSnapshot");
                });
