...
namespace EPR.Payment.Service.Common.Data.Repositories.RegistrationFees
{
    public class ProducerFeesRepository : BaseFeeRepository, IProducerFeesRepository
    {
        ...
        {
            var fee = await GetFeeAsync(GroupTypeConstants.ProducerType, producer, regulator, cancellationToken);
        ...
        {
            var fee = await GetFeeAsync(GroupTypeConstants.ProducerSubsidiaries, SubsidiariesConstants.UpTo20, regulator, cancellationToken);
        ...
        {
            var fee = await GetFeeAsync(GroupTypeConstants.ProducerSubsidiaries, SubsidiariesConstants.MoreThan20, regulator, cancellationToken);
        ...
        {
            var fee = await GetFeeAsync(GroupTypeConstants.ProducerType, SubGroupTypeConstants.OnlineMarket, regulator, cancellationToken);
        ...
        {
            var fee = await GetFeeAsync(GroupTypeConstants.ProducerType, SubGroupTypeConstants.LateFee, regulator, cancellationToken);
        ...
        {
            var fee = await GetFeeAsync(GroupTypeConstants.ProducerResubmission, SubGroupTypeConstants.ReSubmitting, regulator, cancellationToken);
