...
{
    public class ReprocessorOrExporterFeesRequestDtoCommonValidator<T> : AbstractValidator<T> where T : ReprocessorOrExporterRegistrationFeesRequestDto
    {
        public ReprocessorOrExporterFeesRequestDtoCommonValidator()
        {
