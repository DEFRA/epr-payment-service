...
namespace EPR.Payment.Service.Data.UnitTests.Repositories.RegistrationFees
{
    ...
    public class ComplianceSchemeFeesRepositoryTests
    {
            ...
            [Greedy] ComplianceSchemeFeesRepository _complianceSchemeFeesRepository)
        {
            ...
            // Act
            var result = await _complianceSchemeFeesRepository.GetBaseFeeAsync(RegulatorType.Create("GB-ENG"), DateTime.Now, _cancellationToken);
            ...
            [Greedy] ComplianceSchemeFeesRepository _complianceSchemeFeesRepository)
        {
            ...
            // Act
            Func<Task> act = async () => await _complianceSchemeFeesRepository.GetBaseFeeAsync(RegulatorType.Create("GB-INVALID"), DateTime.Now, _cancellationToken);
            ...
            [Greedy] ComplianceSchemeFeesRepository _complianceSchemeFeesRepository)
        {
            ...
            // Act
            var result = await _complianceSchemeFeesRepository.GetMemberFeeAsync("Large", RegulatorType.Create("GB-ENG"), DateTime.Now, _cancellationToken);
            ...
            [Greedy] ComplianceSchemeFeesRepository _complianceSchemeFeesRepository)
        {
            ...
            // Act
            Func<Task> act = async () => await _complianceSchemeFeesRepository.GetMemberFeeAsync("InvalidType", RegulatorType.Create("GB-ENG"), DateTime.Now, _cancellationToken);
            ...
            [Greedy] ComplianceSchemeFeesRepository _complianceSchemeFeesRepository)
        {
            ...
            // Act
            var result = await _complianceSchemeFeesRepository.GetMemberFeeAsync("Small", RegulatorType.Create("GB-ENG"), DateTime.Now, _cancellationToken);
            ...
            [Greedy] ComplianceSchemeFeesRepository _complianceSchemeFeesRepository)
        {
            ...
            // Act
            var result = await _complianceSchemeFeesRepository.GetOnlineMarketFeeAsync(RegulatorType.Create("GB-ENG"), DateTime.Now, _cancellationToken);
            ...
            [Greedy] ComplianceSchemeFeesRepository _complianceSchemeFeesRepository)
        {
            ...
            // Act
            var result = await _complianceSchemeFeesRepository.GetFirstBandFeeAsync(RegulatorType.Create("GB-ENG"), DateTime.Now, _cancellationToken);
            ...
            [Greedy] ComplianceSchemeFeesRepository _complianceSchemeFeesRepository)
        {
            ...
            // Act
            var result = await _complianceSchemeFeesRepository.GetSecondBandFeeAsync(RegulatorType.Create("GB-ENG"), DateTime.Now, _cancellationToken);
           ...
           [Greedy] ComplianceSchemeFeesRepository _complianceSchemeFeesRepository)
        {
            ...
            // Act
            var result = await _complianceSchemeFeesRepository.GetThirdBandFeeAsync(RegulatorType.Create("GB-ENG"), DateTime.Now, _cancellationToken);
            ...
            [Greedy] ComplianceSchemeFeesRepository _complianceSchemeFeesRepository)
        {
            ...
            // Act
            var result = await _complianceSchemeFeesRepository.GetLateFeeAsync(RegulatorType.Create("GB-ENG"), DateTime.Now, _cancellationToken);
            ...
            [Greedy] ComplianceSchemeFeesRepository _complianceSchemeFeesRepository)
        {
            ...
            // Act
            Func<Task> act = async () => await _complianceSchemeFeesRepository.GetLateFeeAsync(RegulatorType.Create("GB-ENG"), DateTime.Now, _cancellationToken);
