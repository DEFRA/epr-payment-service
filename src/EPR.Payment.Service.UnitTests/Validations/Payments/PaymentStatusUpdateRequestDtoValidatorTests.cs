...
namespace EPR.Payment.Service.UnitTests.Validations.Payments
{
    ...
    public class PaymentStatusUpdateRequestDtoValidatorTests
    {
        ...
        {
            var paymentStatusUpdateRequestDto = new PaymentStatusUpdateRequestDto { Status = (Service.Common.Dtos.Enums.Status)999 };
            var result = _validator.TestValidate(paymentStatusUpdateRequestDto);
        ...
        {
            var paymentStatusUpdateRequestDto = new PaymentStatusUpdateRequestDto { Status = Service.Common.Dtos.Enums.Status.Initiated };
            var result = _validator.TestValidate(paymentStatusUpdateRequestDto);
